...
// Gem colors. ONYX is the rare, high-value special gem.
export const GEM_COLORS = ["RED", "BLUE", "GREEN", "YELLOW", "PURPLE", "ONYX"];
...
export const GEM_RENDER_COLORS = {
  ...
  YELLOW: { base: "#d4b23a", light: "#ffe79a", dark: "#5c4a12" },
